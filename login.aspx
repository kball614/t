...
<body>
    ...
    <div style="width: 1267px" >
        ...
        <asp:Label ID="Label1" runat="server" style="z-index: 1; left: 538px; top: 688px; position: absolute" Text="帳號" Font-Size="XX-Large"></asp:Label>
    ...
    &nbsp;&nbsp;&nbsp;
        ...
        <asp:Label ID="Label2" runat="server" style="z-index: 1; left: 537px; top: 788px; position: absolute" Text="密碼" Font-Size="XX-Large"></asp:Label>
