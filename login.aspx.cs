...
public partial class login : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter sda = new SqlDataAdapter("SELECT * FROM StudentProfile where Sid = @Sid AND Spaw = @Spaw", cn);
        ...
        using (cn)
        {
            ...
            sda.SelectCommand.Parameters.AddWithValue("@Sid", username);
            sda.SelectCommand.Parameters.AddWithValue("@Spaw", password);
